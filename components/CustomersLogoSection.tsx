export const CustomersLogoSection = () => {
  const logosRowOne = [
    {
      id: "jitter",
      src: "/logos/jitter.svg",
      alt: "Jitter Logo",
    },
    {
      id: "krisp",
    ...
    {
      id: "feedly",
      src: "/logos/feedly.svg",
      alt: "Feedly Logo",
    },
    {
      id: "draftbit",
      src: "/logos/draftbit.svg",
      alt: "Draftbit Logo",
    },
    {
      id: "hellosign",
      src: "/logos/hellosign.svg",
      alt: "Hellosign Logo",
    },
    {
      id: "grammarly",
      src: "/logos/grammarly.svg",
      alt: "Grammarly Logo",
    },
  ];
  ...
  const logosRowTwo = [
    ...
    {
      id: "people",
      src: "/logos/people.svg",
      alt: "People Logo",
    },
    {
      id: "livechat",
      src: "/logos/livechat.svg",
      alt: "Livechat Logo",
    },
    {
      id: "sketch",
  ...
  return (
    <div className="mt-[5.4375rem] flex flex-col items-center px-4 sm:px-[6.25rem]">
      <div className="flex items-center gap-[0.625rem] text-[1.0625rem] font-medium leading-[1.875rem]">
        Trusted By 20,000+
        <svg
          width="78"
          height="13"
      ...
      <div className="mt-[1.375rem] text-center font-heading text-5xl font-semibold leading-[3.125rem]">
        They <span className="bg-highlight">Trust</span> Us.
      </div>
      <div className="mt-[1.4375rem] w-screen">
        <div className="hide-scrollbar flex justify-center gap-5 overflow-auto px-[1.875rem] py-[0.9375rem]">
          {logosRowOne.map((logo) => {
            return (
              <div
                key={logo.id}
                className="flex h-24 flex-none items-center rounded-full bg-white px-[2.625rem] hover:drop-shadow-default"
              >
